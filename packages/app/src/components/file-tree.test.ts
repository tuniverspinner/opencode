...
beforeAll(async () => {
  ...
  mock.module("@cyf-ai/ui/collapsible", () => ({
    Collapsible: {
      Trigger: (props: { children?: unknown }) => props.children,
      Content: (props: { children?: unknown }) => props.children,
    },
  }))
  mock.module("@cyf-ai/ui/file-icon", () => ({ FileIcon: () => null }))
  mock.module("@cyf-ai/ui/icon", () => ({ Icon: () => null }))
  mock.module("@cyf-ai/ui/tooltip", () => ({ Tooltip: (props: { children?: unknown }) => props.children }))
