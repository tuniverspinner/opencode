...
export const TypeId: TypeId = "~@cyf-ai/effect-sqlite-node/NodeSqliteClient"
export type TypeId = "~@cyf-ai/effect-sqlite-node/NodeSqliteClient"
...
export const SqliteClient = Context.Service<SqliteClient>("@cyf-ai/effect-sqlite-node/NodeSqliteClient")
