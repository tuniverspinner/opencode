...
const releaseId = process.env.CYF_RELEASE
if (!releaseId) throw new Error("CYF_RELEASE is required")

const version = process.env.CYF_VERSION
if (!version) throw new Error("CYF_VERSION is required")
