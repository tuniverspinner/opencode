...
import { ProjectDirectoryTable, ProjectTable } from "@cyf-ai/core/project/sql"
...
import { which } from "@cyf-ai/core/util/which"
...
import { AbsolutePath, NonNegativeInt, optionalOmitUndefined } from "@cyf-ai/core/schema"
...
export const layer = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const fakeVcs = Schema.decodeUnknownSync(Schema.optional(ProjectVcs))(Flag.CYF_FAKE_VCS)
