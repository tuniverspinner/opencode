import type * as SDK from "@cyf-ai/sdk/v2"
...
import { SessionShareTable } from "@cyf-ai/core/share/sql"
...
const disabled = process.env["CYF_DISABLE_SHARE"] === "true" || process.env["CYF_DISABLE_SHARE"] === "1"
