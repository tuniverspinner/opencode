import { PermissionV1 } from "@cyf-ai/core/v1/permission"
import { Slug } from "@cyf-ai/core/util/slug"
import { SessionV1 } from "@cyf-ai/core/v1/session"
import { serviceUse } from "@cyf-ai/core/effect/service-use"
import path from "path"
import { BackgroundJob } from "@/background/job"
import { Decimal } from "decimal.js"
import type { ProviderMetadata, Usage } from "@cyf-ai/llm"
import { InstallationVersion } from "@cyf-ai/core/installation/version"
...
import { PartTable, SessionTable } from "@cyf-ai/core/session/sql"
import { ProjectTable } from "@cyf-ai/core/project/sql"
import { Log } from "@cyf-ai/core/util/log"
...
import { NonNegativeInt, optionalOmitUndefined } from "@cyf-ai/core/schema"
...
export function plan(input: { slug: string; time: { created: number } }, instance: InstanceContext) {
  const base = instance.project.vcs
    ? path.join(instance.worktree, ".cyf", "plans")
