import type { JsonSchema, LLMRequest, ProviderMetadata } from "@cyf-ai/llm"
import { LLM, Message, SystemPart, ToolCallPart, ToolDefinition, ToolResultPart } from "@cyf-ai/llm"
import {
  AmazonBedrock,
  Anthropic,
  Azure,
...
export const request = (input: RequestInput) => {
  ...
  // @cyf-ai/llm request objects from opencode's session/AI SDK-shaped data.
  return LLM.request({
