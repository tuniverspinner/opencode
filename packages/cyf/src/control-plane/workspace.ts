...
import { EventSequenceTable, EventTable } from "@cyf-ai/core/event/sql"
...
export const layer = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const create = Effect.fn("Workspace.create")(function* (input: CreateInput) {
      ...
      const env = {
        CYF_AUTH_CONTENT: JSON.stringify(yield* auth.all()),
        CYF_WORKSPACE_ID: config.id,
        CYF_EXPERIMENTAL_WORKSPACES: "true",
