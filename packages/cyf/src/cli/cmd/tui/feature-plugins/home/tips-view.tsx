import type { TuiPluginApi } from "@cyf-ai/plugin/tui"
...
const TIPS: Tip[] = [
  ...
  "Create a plugin to prevent CYF from reading sensitive files",
  "Use {highlight}cyf run{/highlight} for non-interactive scripting",
  "Use {highlight}cyf --continue{/highlight} to resume the last session",
  "Use {highlight}cyf run -f file.ts{/highlight} to attach files via CLI",
  "Use {highlight}--format json{/highlight} for machine-readable output in scripts",
  "Run {highlight}cyf serve{/highlight} for headless API access to CYF",
  "Use {highlight}cyf run --attach{/highlight} to connect to a running server",
  "Run {highlight}cyf upgrade{/highlight} to update to the latest version",
  "Run {highlight}cyf auth list{/highlight} to see all configured providers",
  "Run {highlight}cyf agent create{/highlight} for guided agent creation",
  "Use {highlight}/cyf{/highlight} in GitHub issues/PRs to trigger AI actions",
  "Run {highlight}cyf github install{/highlight} to set up the GitHub workflow",
  "Comment {highlight}/cyf fix this{/highlight} on issues to auto-create PRs",
  ...
  "Run {highlight}cyf debug config{/highlight} to troubleshoot configuration",
