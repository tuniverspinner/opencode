...
} from "@cyf-ai/plugin/tui"
import stripAnsi from "strip-ansi"
import type { TuiConfig } from "./config/tui"
import { isAttentionSoundName } from "./config/tui-schema"
import * as TuiAudio from "@tui/util/audio"
import defaultSoundPath from "@cyf-ai/ui/audio/bip-bop-01.mp3" with { type: "file" }
import questionSoundPath from "@cyf-ai/ui/audio/bip-bop-03.mp3" with { type: "file" }
import permissionSoundPath from "@cyf-ai/ui/audio/staplebops-06.mp3" with { type: "file" }
import errorSoundPath from "@cyf-ai/ui/audio/nope-03.mp3" with { type: "file" }
import doneSoundPath from "@cyf-ai/ui/audio/bip-bop-01.mp3" with { type: "file" }
import subagentDoneSoundPath from "@cyf-ai/ui/audio/yup-01.mp3" with { type: "file" }
