...
describe("opencode read-only commands (smoke)", () => {
  ...
  // CYF_CONFIG_CONTENT={} we provide, no servers should be configured
  ...
  // `session list` reads the session DB. Fresh CYF_TEST_HOME means
  ...
  // in production it'd be a path under CYF_TEST_HOME / XDG_DATA_HOME.
