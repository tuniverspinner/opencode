  ...
  Effect.gen(function* () {
    ...
    yield* Effect.addFinalizer(() =>
      Effect.sync(() => {
        ...
        restoreEnv("CYF_SERVER_PASSWORD", original.envPassword)
        restoreEnv("CYF_SERVER_USERNAME", original.envUsername)
      }),
    )
  }),
)
      ...
      Layer.provide(
        ConfigProvider.layer(
          ConfigProvider.fromUnknown({
            CYF_SERVER_PASSWORD: input?.password,
            CYF_SERVER_USERNAME: input?.username,
          }),
        ),
      ),
    ),
