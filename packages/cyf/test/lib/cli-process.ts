...
//   - CYF_CONFIG_CONTENT      : provider config inline, no files to find
//   - CYF_TEST_HOME           : pins os.homedir() → tmpdir
//   - CYF_DISABLE_PROJECT_CONFIG : skip walking up for opencode.json
//   - CYF_PURE                : skip external plugin discovery + install
//   - CYF_DISABLE_AUTOUPDATE / AUTOCOMPACT / MODELS_FETCH : no background work
...
function isolatedEnv(home: string, configJson: string): Record<string, string> {
  return {
    ...
    CYF_CONFIG_CONTENT: configJson,
    CYF_DISABLE_PROJECT_CONFIG: "1",
    CYF_PURE: "1",
    CYF_DISABLE_AUTOUPDATE: "1",
    CYF_DISABLE_AUTOCOMPACT: "1",
    CYF_DISABLE_MODELS_FETCH: "1",
    CYF_AUTH_CONTENT: "{}",
  }
}
