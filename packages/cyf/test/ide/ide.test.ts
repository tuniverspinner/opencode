...
describe("ide", () => {
  ...
  test("should recognize vscode-insiders CYF_CALLER", () => {
    process.env["CYF_CALLER"] = "vscode-insiders"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should recognize vscode CYF_CALLER", () => {
    process.env["CYF_CALLER"] = "vscode"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should return false for unknown CYF_CALLER", () => {
    process.env["CYF_CALLER"] = "unknown"
